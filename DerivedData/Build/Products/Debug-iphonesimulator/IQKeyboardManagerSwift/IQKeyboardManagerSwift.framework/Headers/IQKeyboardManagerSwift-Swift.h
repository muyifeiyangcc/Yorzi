...
/// <code>view.iq.distanceFromKeyboard</code> for specific views.
/// precondition:
/// Value must be non-negative. Negative values will be logged as warnings.
/// note:
/// This is a global setting. Use <code>view.iq.distanceFromKeyboard</code> for per-view customization.
/// <ul>
///   <li>
///     Default: <code>10.0</code> points
///   </li>
/// </ul>
/// <h2>Example</h2>
/// \code
...
///
/// \endcodeseealso:
/// <code>UIView.iq.distanceFromKeyboard</code> for per-view customization
...
/// is disabled regardless of the <code>isEnabled</code> property.
/// precondition:
/// All classes must be subclasses of <code>UIViewController</code>
/// note:
/// This takes precedence over <code>enabledDistanceHandlingClasses</code>. If a class appears
/// in both arrays, it will be disabled.
/// <ul>
///   <li>
///     Default: <code>[UITableViewController.self, UIInputViewController.self, UIAlertController.self]</code>
///   </li>
/// </ul>
/// <h2>Example</h2>
/// \code
...
///
/// \endcodeseealso:
/// <code>enabledDistanceHandlingClasses</code> for force-enabling specific classes
...
/// <ul>
///   <li>
///     <code>isEnabled</code> is <code>true</code>
///   </li>
///   <li>
...
/// </ul>
/// seealso:
/// <code>isEnabled</code> for enabling/disabling the manager
...
SWIFT_ENUM_FWD_DECL(NSInteger, IQKeyboardToolbarManageBehavior)
SWIFT_ENUM_FWD_DECL(NSInteger, IQPreviousNextDisplayMode)
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardManager (SWIFT_EXTENSION(IQKeyboardManagerSwift))
...
SWIFT_ENUM_FWD_DECL(NSInteger, IQEnableMode)
